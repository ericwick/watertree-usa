		...
		return (
			<div>
				{navStatus === 'nav' ? (
					<nav className='navbar' onClick={this.scrollToTop}>
						...
						<div className='navbar__links'>
							{sections.map((e, i) => {
								return (
									<Link key={i} className='navbar__links--link' to={e.name} spy={true} smooth={true} duration={500}>
						...
						<div className='navbar__social-media'>
							<a href='https://www.instagram.com/watertreeusa/' className='navbar__social-media--link'>
								<i className='navbar__social-media--app fab fa-instagram blue fa-lg' />
							</a>
							<a href='https://www.facebook.com/watertreeusa/' className='navbar__social-media--link'>
				...
				<Element name='title' id='title'>
					<Title navStatus={navStatus} sections={sections} setNavBarLinks={this.setNavBarLinks} />
				</Element>
